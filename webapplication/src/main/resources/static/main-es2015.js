...
let UserComponentComponent = class UserComponentComponent {
    constructor(formBuilder, http, userComponentService) {
...
UserComponentComponent.ctorParameters = () => [
...
let UserComponentService = class UserComponentService {
    constructor() {
        this.serverUrl = 'http://localhost:8086/socket';
    }
    initializeWebSocketConnection() {
        let ws = new sockjs_client__WEBPACK_IMPORTED_MODULE_3___default.a(this.serverUrl, null, { 'protocols_whitelist': ['websocket'] });
